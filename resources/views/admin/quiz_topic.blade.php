        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="card row col-md-3 d-inline-block" style="height:150px;width:300px; margin:10px;background-color: #eac5c5;   ">
                   ...
                   <h4 class="text-center">total Examiner:{{ $data->quiz_submit_user->where("quiz_id",$data->id)->pluck('user_id')->unique()->count() }} <a href="{{ route('quiz_examiner',$data->id) }}" class="btn btn-outline-info">view</a></h4>
