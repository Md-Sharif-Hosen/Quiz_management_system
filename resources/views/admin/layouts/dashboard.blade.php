...
<body data-sidebar="dark" data-layout-mode="light">
                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        ...
                        <a href="index.html" class="logo logo-light">
                            <span class="logo-sm">
                                <img src="{{ asset('assets/admin/assets') }}/images/logo-light.svg" alt=""
                                    height="22">
                            </span>
                            <span class="logo-lg">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                            <div class="px-lg-2">
                                <div class="row g-0">
                                    <div class="col">
                                        <a class="dropdown-icon-item" href="#">
                                            <img src="{{ asset('assets/admin/assets') }}/images/brands/github.png"
                                                alt="Github">
                                            <span>GitHub</span>
                                        </a>
                                    </div>
                                    <div class="col">
                                        <a class="dropdown-icon-item" href="#">
                                            <img src="{{ asset('assets/admin/assets') }}/images/brands/bitbucket.png"
                                                alt="bitbucket">
                                            <span>Bitbucket</span>
                                        </a>
                                    </div>
                                    <div class="col">
                                        <a class="dropdown-icon-item" href="#">
                                            <img src="{{ asset('assets/admin/assets') }}/images/brands/dribbble.png"
                                                alt="dribbble">
                                            <span>Dribbble</span>
                                        </a>
                                    </div>
                                ...
                                <div class="row g-0">
                                    <div class="col">
                                        <a class="dropdown-icon-item" href="#">
                                            <img src="{{ asset('assets/admin/assets') }}/images/brands/dropbox.png"
                                                alt="dropbox">
                                            <span>Dropbox</span>
                                        </a>
                                    </div>
                                    <div class="col">
                                        <a class="dropdown-icon-item" href="#">
                                            <img src="{{ asset('assets/admin/assets') }}/images/brands/mail_chimp.png"
                                                alt="mail_chimp">
                                    ...
                                    <div class="col">
                                        <a class="dropdown-icon-item" href="#">
                                            <img src="{{ asset('assets/admin/assets') }}/images/brands/slack.png"
                                                alt="slack">
                                            <span>Slack</span>
                                        </a>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 ">
                            <div class="text-sm-end d-none d-sm-block">
                                © Design & Develop by M Sharif Ahmed
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="right-bar">
        <div data-simplebar class="h-100">
            ...
            <div class="p-4">
                <div class="mb-2">
                    <img src="{{ asset('assets/admin/assets') }}/images/layouts/layout-1.jpg" class="img-thumbnail"
                        alt="layout images">
                </div>
                ...
                <div class="mb-2">
                    <img src="{{ asset('assets/admin/assets') }}/images/layouts/layout-2.jpg" class="img-thumbnail"
                        alt="layout images">
                </div>
                <div class="form-check form-switch mb-3">
                ...
                <div class="mb-2">
                    <img src="{{ asset('assets/admin/assets') }}/images/layouts/layout-3.jpg" class="img-thumbnail"
                        alt="layout images">
                </div>
                <div class="form-check form-switch mb-3">
                ...
                <div class="mb-2">
                    <img src="{{ asset('assets/admin/assets') }}/images/layouts/layout-4.jpg" class="img-thumbnail"
                        alt="layout images">
                </div>
...
<script src="{{ asset('assets/admin') }}/js/assets/icons/feather-icons/feather.min.js"></script>
...
<!-- Mirrored from eduadmin-template.multipurposethemes.com/bs4/main-dark/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Jul 2023 04:45:18 GMT -->
