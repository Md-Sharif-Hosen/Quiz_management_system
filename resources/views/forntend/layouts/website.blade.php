...
<body>
   ...
   <!--====== PRELOADER PART START ======-->
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="singel-items text-center mt-30">
                        <div class="items-image">
                            <img src="{{ asset('assets/website') }}/images/category/ctg-1.jpg" alt="Category">
                        </div>
                        <div class="items-cont">
                            <a href="{{ asset('assets/website') }}/#">
                                <h5>App Design</h5>
            ...
            <div class="row course-slied mt-30">
                <div class="col-lg-4">
                    <div class="singel-course-2">
                        <div class="thum">
                            <div class="image">
                                <img src="{{ asset('assets/website') }}/images/course/cu-1.jpg" alt="Course">
                            </div>
                            <div class="price">
                                <span>Free</span>
                            </div>
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="{{ asset('assets/website') }}/courses-singel.html"><img src="{{ asset('assets/website') }}/images/course/teacher/t-1.jpg" alt="teacher"></a>
                                </div>
                                <div class="name">
                                    <a href="{{ asset('assets/website') }}/#"><h6>Mark anthem</h6></a>
                                </div>
                                <div class="review">
                                    <ul>
                        ...
                        <div class="cont">
                            <a href="{{ asset('assets/website') }}/#"><h4>Learn basis javascirpt from start for beginner</h4></a>
                        </div>
                    </div> <!-- singel course -->
                </div>
                <div class="col-lg-4">
                    <div class="singel-course-2">
                        <div class="thum">
                            <div class="image">
                                <img src="{{ asset('assets/website') }}/images/course/cu-2.jpg" alt="Course">
                            </div>
                            <div class="price">
                                <span>Free</span>
                            </div>
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="{{ asset('assets/website') }}/courses-singel.html"><img src="{{ asset('assets/website') }}/images/course/teacher/t-2.jpg" alt="teacher"></a>
                                </div>
                                <div class="name">
                                    <a href="{{ asset('assets/website') }}/#"><h6>Mark anthem</h6></a>
                                </div>
                ...
                <div class="col-lg-4">
                    <div class="singel-course-2">
                        <div class="thum">
                            <div class="image">
                                <img src="{{ asset('assets/website') }}/images/course/cu-3.jpg" alt="Course">
                            </div>
                            <div class="price">
                                <span>Free</span>
                            </div>
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="{{ asset('assets/website') }}/courses-singel.html"><img src="{{ asset('assets/website') }}/images/course/teacher/t-3.jpg" alt="teacher"></a>
                                </div>
                                <div class="name">
                                    <a href="{{ asset('assets/website') }}/#"><h6>Mark anthem</h6></a>
                                </div>
                ...
                <div class="col-lg-4">
                    <div class="singel-course-2">
                        <div class="thum">
                            <div class="image">
                                <img src="{{ asset('assets/website') }}/images/course/cu-4.jpg" alt="Course">
                            </div>
                            <div class="price">
                                <span>Free</span>
                            </div>
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="{{ asset('assets/website') }}/courses-singel.html"><img src="{{ asset('assets/website') }}/images/course/teacher/t-4.jpg" alt="teacher"></a>
                                </div>
                                <div class="name">
                                    <a href="{{ asset('assets/website') }}/#"><h6>Mark anthem</h6></a>
                                </div>
                ...
                <div class="col-lg-4">
                    <div class="singel-course-2">
                        <div class="thum">
                            <div class="image">
                                <img src="{{ asset('assets/website') }}/images/course/cu-5.jpg" alt="Course">
                            </div>
                            <div class="price">
                                <span>Free</span>
                            </div>
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="{{ asset('assets/website') }}/courses-singel.html"><img src="{{ asset('assets/website') }}/images/course/teacher/t-5.jpg" alt="teacher"></a>
                                </div>
                                <div class="name">
                                    <a href="{{ asset('assets/website') }}/#"><h6>Mark anthem</h6></a>
                                </div>
    ...
    <section id="count-down-part" class="bg_cover pt-70 pb-120" data-overlay="8" style="background-image: url({{ asset('assets/website') }}/images/bg-2.jpg)">
        <div class="container">
    ...
    <section id="event-part" class="pt-120 pb-120">
        <div class="container">
            <div class="event-bg bg_cover" style="background-image: url({{ asset('assets/website') }}/images/bg-3.jpg)">
                <div class="row">
                            ...
                            <ul>
                                <li>
                                    <div class="singel-event">
                                        ...
                                        <a href="{{ asset('assets/website') }}/events-singel.html"><h4>Campus clean workshop</h4></a>
                                ...
                                <li>
                                    <div class="singel-event">
                                        <span><i class="fa fa-calendar"></i> 2 December 2018</span>
                                        <a href="{{ asset('assets/website') }}/events-singel.html"><h4>Tech Summit</h4></a>
                                        <span><i class="fa fa-clock-o"></i> 10:00 Am - 3:00 Pm</span>
                                        <span><i class="fa fa-map-marker"></i> Rc Auditorim</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="singel-event">
                                        <span><i class="fa fa-calendar"></i> 2 December 2018</span>
                                        <a href="{{ asset('assets/website') }}/events-singel.html"><h4>Enviroement conference</h4></a>
                                        <span><i class="fa fa-clock-o"></i> 10:00 Am - 3:00 Pm</span>
                                        <span><i class="fa fa-map-marker"></i> Rc Auditorim</span>
                                    </div>
                                </li>
                ...
                <div class="col-lg-6">
                    <div class="singel-news mt-30">
                        <div class="news-thum pb-25">
                            <img src="{{ asset('assets/website') }}/images/news/n-1.jpg" alt="News">
                        </div>
                        <div class="news-cont">
                            <ul>
                                <li><a href="{{ asset('assets/website') }}/#"><i class="fa fa-calendar"></i>2 December 2018 </a></li>
                                <li><a href="{{ asset('assets/website') }}/#"> <span>By</span> Adam linn</a></li>
                            </ul>
                            <a href="{{ asset('assets/website') }}/blog-singel.html"><h3>Tips to grade high cgpa in university life</h3></a>
                ...
                <div class="col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="news-thum mt-30">
                                    <img src="{{ asset('assets/website') }}/images/news/ns-1.jpg" alt="News">
                                </div>
                            </div>
                            <div class="col-sm-8">
                                <div class="news-cont mt-30">
                                    ...
                                    <a href="{{ asset('assets/website') }}/blog-singel.html"><h3>Intellectual communication</h3></a>
                    ...
                    <div class="singel-news news-list">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="news-thum mt-30">
                                    <img src="{{ asset('assets/website') }}/images/news/ns-2.jpg" alt="News">
                                </div>
                            </div>
                            <div class="col-sm-8">
                                <div class="news-cont mt-30">
                                    ...
                                    <a href="{{ asset('assets/website') }}/blog-singel.html"><h3>Study makes you perfect</h3></a>
                                    <p>Gravida nibh vel velit auctor aliquetn sollicitudirem quibibendum auci elit cons  vel.</p>
                                </div>
                            </div>
                        </div> <!-- row -->
                    ...
                    <div class="singel-news news-list">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="news-thum mt-30">
                                    <img src="{{ asset('assets/website') }}/images/news/ns-3.jpg" alt="News">
                                </div>
                            </div>
                            <div class="col-sm-8">
                                <div class="news-cont mt-30">
                                    ...
                                    <a href="{{ asset('assets/website') }}/blog-singel.html"><h3>Technology edcution is now....</h3></a>
                                    <p>Gravida nibh vel velit auctor aliquetn sollicitudirem quibibendum auci elit cons  vel.</p>
                                </div>
                            </div>
                        </div> <!-- row -->
            ...
            <div class="row patnar-slied">
                <div class="col-lg-12">
                    <div class="singel-patnar text-center mt-40">
                        <img src="{{ asset('assets/website') }}/images/patnar-logo/p-1.png" alt="Logo">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="singel-patnar text-center mt-40">
                        <img src="{{ asset('assets/website') }}/images/patnar-logo/p-2.png" alt="Logo">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="singel-patnar text-center mt-40">
                        <img src="{{ asset('assets/website') }}/images/patnar-logo/p-3.png" alt="Logo">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="singel-patnar text-center mt-40">
                        <img src="{{ asset('assets/website') }}/images/patnar-logo/p-4.png" alt="Logo">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="singel-patnar text-center mt-40">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-about mt-40">
                            <div class="logo">
                                <a href="{{ asset('assets/website') }}/#"><img src="{{ asset('assets/website') }}/images/logo-2.png" alt="Logo"></a>
                            </div>
                            <p>Gravida nibh vel velit auctor aliquetn quibibendum auci elit cons equat ipsutis sem nibh id elit. Duis sed odio sit amet nibh vulputate.</p>
                            <ul class="mt-20">
                                <li><a href="{{ asset('assets/website') }}/#"><i class="fa fa-facebook-f"></i></a></li>
                                <li><a href="{{ asset('assets/website') }}/#"><i class="fa fa-twitter"></i></a></li>
                                <li><a href="{{ asset('assets/website') }}/#"><i class="fa fa-google-plus"></i></a></li>
                                <li><a href="{{ asset('assets/website') }}/#"><i class="fa fa-instagram"></i></a></li>
                            </ul>
                        </div> <!-- footer about -->
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="footer-link mt-40">
                            ...
                            <ul>
                                <li><a href="{{ asset('assets/website') }}/index-2.html"><i class="fa fa-angle-right"></i>Home</a></li>
                                <li><a href="{{ asset('assets/website') }}/about.html"><i class="fa fa-angle-right"></i>About us</a></li>
                                <li><a href="{{ asset('assets/website') }}/courses.html"><i class="fa fa-angle-right"></i>Courses</a></li>
                                <li><a href="{{ asset('assets/website') }}/blog.html"><i class="fa fa-angle-right"></i>News</a></li>
                                <li><a href="{{ asset('assets/website') }}/events.html"><i class="fa fa-angle-right"></i>Event</a></li>
                            </ul>
                            <ul>
                                <li><a href="{{ asset('assets/website') }}/#"><i class="fa fa-angle-right"></i>Gallery</a></li>
                                <li><a href="{{ asset('assets/website') }}/shop.html"><i class="fa fa-angle-right"></i>Shop</a></li>
                                <li><a href="{{ asset('assets/website') }}/teachers.html"><i class="fa fa-angle-right"></i>Teachers</a></li>
                                <li><a href="{{ asset('assets/website') }}/#"><i class="fa fa-angle-right"></i>Support</a></li>
                                <li><a href="{{ asset('assets/website') }}/contact.html"><i class="fa fa-angle-right"></i>Contact</a></li>
                            </ul>
                        </div> <!-- footer link -->
                    </div>
                    <div class="col-lg-2 col-md-6 col-sm-6">
                        <div class="footer-link support mt-40">
                            ...
                            <ul>
                                <li><a href="{{ asset('assets/website') }}/#"><i class="fa fa-angle-right"></i>FAQS</a></li>
                                <li><a href="{{ asset('assets/website') }}/#"><i class="fa fa-angle-right"></i>Privacy</a></li>
                                <li><a href="{{ asset('assets/website') }}/#"><i class="fa fa-angle-right"></i>Policy</a></li>
                                <li><a href="{{ asset('assets/website') }}/#"><i class="fa fa-angle-right"></i>Support</a></li>
                                <li><a href="{{ asset('assets/website') }}/#"><i class="fa fa-angle-right"></i>Documentation</a></li>
                            </ul>
                        </div> <!-- support -->
                    </div>
                    <div class="col-lg-3 col-md-6">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="copyright text-md-left text-center pt-15">
                            <p><a target="_blank" href="{{ asset('assets/website') }}/https://www.templateshub.net">Templates Hub</a> </p>
                        </div>
                    </div>
                    <div class="col-md-4">
    ...
    <a href="{{ asset('assets/website') }}/#" class="back-to-top"><i class="fa fa-angle-up"></i></a>
    ...
    <!--====== jquery js ======-->
    <script src="{{ asset('assets/website') }}/js/vendor/modernizr-3.6.0.min.js"></script>
    ...
    <!--====== Nice Number js ======-->
    <script src="{{ asset('assets/website') }}/js/jquery.nice-number.min.js"></script>
    ...
    <!--====== Ajax Contact js ======-->
    <script src="{{ asset('assets/website') }}/js/ajax-contact.js"></script>
